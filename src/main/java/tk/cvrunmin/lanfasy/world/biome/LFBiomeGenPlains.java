...
public class LFBiomeGenPlains extends LFBiomeBase{
    protected boolean field_150628_aC;

    public LFBiomeGenPlains(int p_i1986_1_)
    {
        super(p_i1986_1_);
    ...
    {
        LFBiomeGenPlains biomegenplains = new LFBiomeGenPlains(p_180277_1_);
        biomegenplains.setBiomeName("Crashing Sunlains");
