...
public class ChunkProviderAltifect implements IChunkProvider
{
    private Random RNG;
    ...
    public ChunkProviderAltifect(World worldIn, long p_i2007_2_)
    {
        this.world = worldIn;
        this.RNG = new Random(p_i2007_2_);
        this.noiseGen1 = new NoiseGeneratorOctaves(this.RNG, 16);
        this.noiseGen2 = new NoiseGeneratorOctaves(this.RNG, 16);
        this.noiseGen3 = new NoiseGeneratorOctaves(this.RNG, 8);
        this.noiseGen4 = new NoiseGeneratorOctaves(this.RNG, 10);
        this.noiseGen5 = new NoiseGeneratorOctaves(this.RNG, 16);

        NoiseGenerator[] noiseGens = {noiseGen1, noiseGen2, noiseGen3, noiseGen4, noiseGen5};
        noiseGens = TerrainGen.getModdedNoiseGenerators(worldIn, this.RNG, noiseGens);
    ...
    {
        ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, chunkX, chunkZ, p_180519_1_, this.world);
    ...
    {
        chunkX = x; chunkZ = z;
        this.RNG.setSeed((long)x * 341873128712L + (long)z * 132897987541L);
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        this.world.getBiomeGenForCoords(blockpos.add(16, 0, 16)).decorate(this.world, this.world.rand, blockpos);
        if(p_73153_2_ * 16 == 0 && p_73153_3_ * 16 == 0){
        new WorldGenAltifect().generate(world, world.rand, new BlockPos( p_73153_2_ * 16, 70, p_73153_3_ * 16));
        }
    ...
    {
        return this.world.getBiomeGenForCoords(p_177458_2_).getSpawnableList(p_177458_1_);
    }
