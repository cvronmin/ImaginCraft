    ...
    private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_)
    {
        ...
        for (int j1 = 0; j1 < 5; ++j1)
        {
            for (int k1 = 0; k1 < 5; ++k1)
            {
                ...
                d8 += d7 * 0.2D;
                d8 = d8 * 8.5d / 8.0D;
                double d10 = 8.5d + d8 * 4.0D;

                for (int j2 = 0; j2 < 33; ++j2)
                {
                    double d11 = ((double)j2 - d10) * 12d * 128.0D / 256.0D / d9;
                    ...
                    double d12 = this.field_147428_e[l] / 512d;
                    double d13 = this.field_147425_f[l] / 512d;
                    double d4 = (this.field_147427_d[l] / 10.0D + 1.0D) / 2.0D;
                    double d5 = MathHelper.denormalizeClamp(d12, d13, d4) - d11;
