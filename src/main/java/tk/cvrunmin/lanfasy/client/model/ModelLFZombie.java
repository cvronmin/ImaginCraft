...
public class ModelLFZombie extends ModelBiped
{

    public ModelLFZombie()
    {
        this(0.0F, false);
    }

    protected ModelLFZombie(float par1, float par2, int par3, int par4)
    {
        super(par1, par2, par3, par4);
    }

    public ModelLFZombie(float par1, boolean par2)
    {
