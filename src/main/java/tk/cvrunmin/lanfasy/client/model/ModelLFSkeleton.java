...
public class ModelLFSkeleton extends ModelLFZombie
{

    public ModelLFSkeleton()
    {
        this(0.0F, false);
    }

    public ModelLFSkeleton(float p_i46303_1_, boolean p_i46303_2_)
    {
    ...
    {
        this.aimedBow = ((LFEntitySkeleton)p_78086_1_).getSkeletonType() == 1;
