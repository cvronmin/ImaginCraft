...
public class LFGuiIngame extends MEGuiIngame
{
    ...
    public static final ResourceLocation icons = new ResourceLocation("lanfasy", "textures/gui/icons.png");
    ...
    public LFGuiIngame(Minecraft mcIn)
    {
    	super(mcIn);
        this.mc = mcIn;
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            this.renderHorseJumpBar(scaledresolution, j1);
        }
        else if (this.mc.playerController.gameIsSurvivalOrAdventure())
        {
            this.renderExpBar(scaledresolution, j1);
        }

        if (this.mc.gameSettings.heldItemTooltips && !this.mc.playerController.isSpectator())
        {
            this.renderHeldItemTooltips(scaledresolution);
        }
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            if (k > 8)
            {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4, l + (k << 24 & -16777216));
                GlStateManager.disableBlend();
...
//            this.drawTexturedModalRect(i - 91, sr.getScaledHeight() - 22, 0, 0, 182, 22);
            drawRect(0, sr.getScaledHeight() - 20, sr.getScaledWidth(), sr.getScaledHeight(), 0, 0, 255, 255);
            drawRect(20 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 20, 20 + entityplayer.inventory.currentItem * 20 + 20, sr.getScaledHeight(), 255, 255, 255, 255);
//            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            ...
            this.renderHotbarItem(new ItemStack(Blocks.chest), 1, sr.getScaledHeight() - 19, partialTicks);
            for (int j = 0; j < 9; ++j)
            {
                int k = sr.getScaledWidth() / 2 - 90 + j * 20 + 2;
                k = 20 + j * 20 + 2;
                int l = sr.getScaledHeight() - 16 - 3;
                l = sr.getScaledHeight() - 20 + 2;
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (this.mc.thePlayer.experienceLevel > 0)
        {
            ...
            l = (p_175176_1_.getScaledWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
            int i1 = p_175176_1_.getScaledHeight() - 31 - 4;
            boolean flag = false;
            this.getFontRenderer().drawString(s, l + 1, i1, 0);
            this.getFontRenderer().drawString(s, l - 1, i1, 0);
            this.getFontRenderer().drawString(s, l, i1 + 1, 0);
            this.getFontRenderer().drawString(s, l, i1 - 1, 0);
            this.getFontRenderer().drawString(s, l, i1, j1);
            this.mc.mcProfiler.endSection();
        }
    }
    ...
    public void renderHeldItemTooltips(ScaledResolution p_175182_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            int i = (p_175182_1_.getScaledWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
	...
	protected void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Iterator iterator = arraylist1.iterator(); iterator.hasNext(); i = Math.max(i, this.getFontRenderer().getStringWidth(s)))
        {
    ...
    protected void func_180476_e(ScaledResolution par1){
    	this.renderPumpkinMask(par1);
    }
    protected void renderPumpkinMask(ScaledResolution p_180476_1_)
    {
        GlStateManager.disableDepth();
    ...
    protected void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_){
    	this.renderBorderAlarm(p_180480_1_, p_180480_2_);
    }
    protected void renderBorderAlarm(float p_180480_1_, ScaledResolution p_180480_2_)
    {
    ...
    protected void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_){
    	this.renderPortalEffect(p_180474_1_, p_180474_2_);
    }
    protected void renderPortalEffect(float p_180474_1_, ScaledResolution p_180474_2_)
    {
        if (p_180474_1_ < 1.0F)
        {
    ...
    protected void renderHotbarItem(int index, int xPos, int yPos, float partialTicks, EntityPlayer p_175184_5_)
    {
        ...
        this.renderHotbarItem(itemstack, xPos, yPos, partialTicks);
/*        if (itemstack != null)
        {
    ...
    protected void renderHotbarItem(ItemStack itemstack, int xPos, int yPos, float partialTicks)
    {
        if (itemstack != null)
        {
            float f1 = (float)itemstack.animationsToGo - partialTicks;
