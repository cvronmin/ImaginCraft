...
public class LFGuiInventory extends LFInventoryEffectRenderer
{
    ...
    public LFGuiInventory(EntityPlayer p_i1094_1_)
    {
    ...
    public void updateScreen()
    {
        ...
        {
            this.mc.displayGuiScreen(new LFGuiContainerCreative(this.mc.thePlayer));
        }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        drawEntityOnScreen(100, 200, 100, (float)(100) - this.oldMouseX, (float)(30) - this.oldMouseY, this.mc.thePlayer);
