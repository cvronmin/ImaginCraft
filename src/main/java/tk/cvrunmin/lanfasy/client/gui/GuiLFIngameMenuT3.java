...
//    	this.renderBackground(this.width, this.height);
    ...
    class GuiExitConfirm extends GuiScreen{
        ...
        protected HoverChecker HoverChecker2;
        protected HoverChecker HoverChecker3;
    	...
    	public void initGui(){
            ...
            {
                ((GuiLFButton)this.buttonList.get(1)).displayString = EnumChatFormatting.BLACK + I18n.format("menu.disconnect", new Object[0]);
            }
            ...
            if (!this.mc.isIntegratedServerRunning())
            {
                ((GuiLFButton)this.buttonList.get(2)).enabled = false;
                ((GuiLFButton)this.buttonList.get(3)).enabled = false;
            }
            this.HoverChecker2 = new HoverChecker(((GuiLFButton)this.buttonList.get(2)), 200);
            this.HoverChecker3 = new HoverChecker(((GuiLFButton)this.buttonList.get(3)), 200);
    	}
        protected void actionPerformed(GuiButton p_146284_1_)
        {
            switch (p_146284_1_.id)
