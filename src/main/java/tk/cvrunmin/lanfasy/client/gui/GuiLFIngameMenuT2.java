...
public class GuiLFIngameMenuT2 extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiMenuButton(100, this.width / 3 * 2 + 10, this.height / 4 + 64 + b0, null, 7));
        this.buttonList.add(new GuiMenuButton(101, this.width / 3 * 2 + 10, this.height / 4 + 84 + b0, null, 6));
