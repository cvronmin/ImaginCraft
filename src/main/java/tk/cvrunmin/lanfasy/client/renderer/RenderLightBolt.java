...
public class RenderLightBolt extends RenderLightningBolt {
    ...
    protected ResourceLocation getEntityTexture(EntityLightBolt entity)
    {
        return null;
    }
    ...
    {
        return this.getEntityTexture((EntityLightBolt)entity);
    }

    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
    {
        this.doRender((EntityLightBolt)entity, x, y, z, p_76986_8_, partialTicks);
    }
}
