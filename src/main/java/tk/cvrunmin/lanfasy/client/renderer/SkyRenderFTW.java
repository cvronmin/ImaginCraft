...
public class SkyRenderFTW extends IRenderHandler{
    private static final ResourceLocation locationMoonPhasesPng = new ResourceLocation("lanfasy", "textures/environment/moon_phases.png");
    private static final ResourceLocation locationSunPng = new ResourceLocation("lanfasy", "textures/environment/sun.png");
