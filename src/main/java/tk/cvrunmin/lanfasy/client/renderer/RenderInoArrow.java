...
public class RenderInoArrow{

	public static class Fire extends Render{
	    private static final ResourceLocation arrowTextures = new ResourceLocation("lanfasy", "textures/entity/ino_arrow/ino_firearrow.png");
	    ...
	    public void doRender(EntityInoArrow.Fire p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_)
	    {
	    ...
	    protected ResourceLocation getEntityTexture(EntityInoArrow.Fire p_180550_1_)
	    {
	    ...
	    {
	        return this.getEntityTexture((EntityInoArrow.Fire)entity);
	    }

	    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
	    {
	        this.doRender((EntityInoArrow.Fire)entity, x, y, z, p_76986_8_, partialTicks);
	    }
	}

	public static class TP extends Render{
	    private static final ResourceLocation arrowTextures = new ResourceLocation("lanfasy", "textures/entity/ino_arrow/ino_tparrow.png");
	    ...
	    public void doRender(EntityInoArrow.TP p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_)
	    {
	        this.bindEntityTexture(p_180551_1_);
	        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
	        GlStateManager.pushMatrix();
	    ...
	    protected ResourceLocation getEntityTexture(EntityInoArrow.TP p_180550_1_)
	    {
	        return arrowTextures;
	    }
	    ...
	    protected ResourceLocation getEntityTexture(Entity entity)
	    {
	        return this.getEntityTexture((EntityInoArrow.TP)entity);
	    }

	    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
	    {
	        this.doRender((EntityInoArrow.TP)entity, x, y, z, p_76986_8_, partialTicks);
	    }
	}
