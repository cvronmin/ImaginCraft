...
public class LayerLFEndermanEyes implements LayerRenderer
{
    private static final ResourceLocation field_177203_a = new ResourceLocation("textures/entity/enderman/enderman_eyes.png");
    private final RenderLFEnderman field_177202_b;

    public LayerLFEndermanEyes(RenderLFEnderman p_i46117_1_)
    {
        this.field_177202_b = p_i46117_1_;
    }

    public void func_177201_a(LFEntityEnderman p_177201_1_, float p_177201_2_, float p_177201_3_, float p_177201_4_, float p_177201_5_, float p_177201_6_, float p_177201_7_, float p_177201_8_)
    {
    ...
    {
        this.func_177201_a((LFEntityEnderman)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}