...
public class RenderFireArrow extends Render{
    ...
    protected ResourceLocation getEntityTexture(EntityFireArrow p_180550_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityFireArrow)entity);
    }

    public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float partialTicks)
    {
        this.doRender((EntityFireArrow)entity, x, y, z, p_76986_8_, partialTicks);
    }
}
