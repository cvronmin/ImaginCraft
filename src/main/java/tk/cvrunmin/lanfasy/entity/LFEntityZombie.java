...
public class LFEntityZombie extends EntityMob{
    ...
    protected void applyEntityAI()
    {
        ...
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true, new Class[] {LFEntityPigZombie.class}));
...
//        return MLRItems.rFlesh;
    ...
    protected void dropRareDrop(int par1)
    {
        ...
        {
            case 0:
//                this.dropItem(MLRItems.rIron_ingot, 1);
                break;
            case 1:
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
        ...
        {
            p_180482_2_1 = new LFEntityZombie.GroupData(this.worldObj.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_180482_2_1 instanceof LFEntityZombie.GroupData)
        {
            LFEntityZombie.GroupData groupdata = (LFEntityZombie.GroupData)p_180482_2_1;
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (cause.getEntity() instanceof EntityCreeper && !(this instanceof LFEntityPigZombie) && ((EntityCreeper)cause.getEntity()).getPowered() && ((EntityCreeper)cause.getEntity()).isAIEnabled())
        {
