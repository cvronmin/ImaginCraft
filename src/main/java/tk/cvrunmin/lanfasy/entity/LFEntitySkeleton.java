...
public class LFEntitySkeleton extends EntityMob implements IRangedAttackMob{
	...
	public void preInit(FMLPreInitializationEvent event){
		EntityRegistry.registerGlobalEntityID(LFEntitySkeleton.class, "Skeleton(ML)", entityID);
		EntityRegistry.registerModEntity(LFEntitySkeleton.class, "Skeleton(ML)", entityID, instance, 64, 1, true);
		EntityList.entityEggs.put(Integer.valueOf(entityID), new EntityList.EntityEggInfo(entityID,  12698049, 4802889));        
	}
	   public LFEntitySkeleton(World par1World)
	    {
	        super(par1World);
