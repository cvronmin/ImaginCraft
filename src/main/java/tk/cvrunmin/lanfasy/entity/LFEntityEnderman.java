...
public class LFEntityEnderman extends EntityMob{
    ...
    public LFEntityEnderman(World worldIn)
    {
        super(worldIn);
        ...
        this.tasks.addTask(10, new LFEntityEnderman.AIPlaceBlock());
        this.tasks.addTask(11, new LFEntityEnderman.AITakeBlock());
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false, new Class[0]));
        this.targetTasks.addTask(2, new LFEntityEnderman.AIFindPlayer());
    ...
    protected boolean teleportTo(double p_70825_1_, double p_70825_3_, double p_70825_5_)
    {
        ...
        else
        {
            ...
            this.worldObj.playSoundEffect(d3, d4, d5, "lanfasy:lfmob.endermen.portal", 1.0F, 1.0F);
            this.playSound("lanfasy:lfmob.endermen.portal", 1.0F, 1.0F);
            return true;
        }
    }
    ...
    {
        return this.isScreaming() ? "lanfasy:lfmob.endermen.scream" : "lanfasy:lfmob.endermen.idle";
    }

    protected String getHurtSound()
    {
        return "lanfasy:lfmob.endermen.hit";
    }

    protected String getDeathSound()
    {
        return "lanfasy:lfmob.endermen.death";
    }
    ...
    class AIFindPlayer extends EntityAINearestAttackableTarget
    {
        ...
        private LFEntityEnderman field_179449_j = LFEntityEnderman.this;

        public AIFindPlayer()
        {
            super(LFEntityEnderman.this, EntityPlayer.class, true);
        }
        ...
        public void resetTask()
        {
            ...
            iattributeinstance.removeModifier(LFEntityEnderman.attackingSpeedBoostModifier);
            super.resetTask();
        }
        ...
        public void updateTask()
        {
            if (this.field_179448_g != null)
            {
                if (--this.field_179450_h <= 0)
                {
                    ...
                    this.field_179449_j.playSound("lanfasy:lfmob.endermen.stare", 1.0F, 1.0F);
                    this.field_179449_j.setScreaming(true);
                    IAttributeInstance iattributeinstance = this.field_179449_j.getEntityAttribute(SharedMonsterAttributes.movementSpeed);
                    iattributeinstance.applyModifier(LFEntityEnderman.attackingSpeedBoostModifier);
                }
            }
            else
            {
    ...
    {
        private LFEntityEnderman field_179475_a = LFEntityEnderman.this;
    ...
    {
        private LFEntityEnderman field_179473_a = LFEntityEnderman.this;
        ...
        public void updateTask()
        {
            ...
            if (LFEntityEnderman.carriableBlocks.contains(block))
            {
