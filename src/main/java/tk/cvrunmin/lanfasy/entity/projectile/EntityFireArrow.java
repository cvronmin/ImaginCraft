...
public class EntityFireArrow extends Entity implements IProjectile{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityFireArrow(World worldIn, EntityLivingBase shooter, float p_i1756_3_)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
        	...
        	worldObj.createExplosion(this, this.posX, this.posY, this.posZ, explosionRadius * 2, flag);
        	this.setDead();
        }
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DamageSourceLF.causeFireArrowDamage(this, this);
                    }
                    else
                    {
                        damagesource = DamageSourceLF.causeFireArrowDamage(this, this.shootingEntity);
                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        ...
                        boolean flag = this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing");
                    	worldObj.createExplosion(this, this.posX, this.posY, this.posZ, explosionRadius, flag);
                    	this.setDead();
