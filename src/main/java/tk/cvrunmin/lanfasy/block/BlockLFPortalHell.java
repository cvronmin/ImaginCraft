...
public class BlockLFPortalHell extends MEBlockBreakable
{
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (worldIn.provider.isSurfaceWorld() && worldIn.getGameRules().getGameRuleBooleanValue("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId())
        {
            ...
            {
                Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, 0, (double)blockpos1.getX() + 0.5D, (double)blockpos1.getY() + 1.1D, (double)blockpos1.getZ() + 0.5D);
    ...
    {
        BlockLFPortalHell.Size size = new BlockLFPortalHell.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            BlockLFPortalHell.Size size1 = new BlockLFPortalHell.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        BlockLFPortalHell.Size size;

        if (axis == EnumFacing.Axis.X)
        {
            size = new BlockLFPortalHell.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            size = new BlockLFPortalHell.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        if (entityIn.ridingEntity == null && entityIn.riddenByEntity == null && (entityIn instanceof EntityPlayerMP))
        {
	           ...
	           {
	                   thePlayer.timeUntilPortal = 10;
	                   thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, -1011, new TeleporterCrashHell(thePlayer.mcServer.worldServerForDimension(-1011)));
	           }
	           else if (thePlayer.dimension == -1011){
	                   thePlayer.timeUntilPortal = 10;
	                   thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 1010, new TeleporterCrashHell(thePlayer.mcServer.worldServerForDimension(1010)));
	           }
        }
    }
    ...
    public static class Size
        {
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    for (i = 0; i < this.field_150868_h; ++i)
                    {
                        ...
                        if (block == LFBlocks.portal_crashhell)
                        {
                            ++this.field_150864_e;
                        }
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == LFBlocks.lffire || p_150857_1_ == LFBlocks.portal_crashhell;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), LFBlocks.portal_crashhell.getDefaultState().withProperty(BlockLFPortalHell.AXIS, this.axis), 2);
                    }
                }
            }
        }
