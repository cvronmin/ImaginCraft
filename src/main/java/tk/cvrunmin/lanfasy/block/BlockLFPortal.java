...
public class BlockLFPortal extends MEBlockBreakable
{
    ...
    {
        BlockLFPortal.Size size = new BlockLFPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            BlockLFPortal.Size size1 = new BlockLFPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        BlockLFPortal.Size size;

        if (axis == EnumFacing.Axis.X)
        {
            size = new BlockLFPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            size = new BlockLFPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != LFBlocks.dremic)
                    {
                        break;
                    }
                }
                ...
                return block == LFBlocks.dremic ? i : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != LFBlocks.dremic)
                    {
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), LFBlocks.lfportal.getDefaultState().withProperty(BlockLFPortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
