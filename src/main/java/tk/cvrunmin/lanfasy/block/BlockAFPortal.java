...
public class BlockAFPortal extends MEBlockContainer
{
    public BlockAFPortal()
    {
        ...
        this.setRegisteredName("afportal");
        this.setUnlocalizedName("afportal");
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
        if (entityIn.ridingEntity == null && entityIn.riddenByEntity == null && (entityIn instanceof EntityPlayerMP))
        {
            ...
            WorldServer worldserver1 = minecraftserver.worldServerForDimension(512);
            int dim = 512;
            if (j == 512)
            {
            ...
            thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, dim, new TeleporterGenatic(worldserver1));
        }
    }
