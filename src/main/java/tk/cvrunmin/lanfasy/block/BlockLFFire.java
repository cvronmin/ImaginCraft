...
public class BlockLFFire extends FBlock
{
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !LFBlocks.lffire.canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    public BlockLFFire()
    {
        ...
        this.setRegisteredName("lf_fire");
        this.setHardness(0.0F);
        this.setLightLevel(1.0F);
        this.setStepSound(soundTypeCloth);
        this.setUnlocalizedName("lf_fire");
        this.disableStats();
    }

    public static void init()
    {
        LFBlocks.lffire.setFireInfo(Blocks.planks, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.double_wooden_slab, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.wooden_slab, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.oak_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.spruce_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.birch_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.jungle_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.dark_oak_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.acacia_fence_gate, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.oak_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.spruce_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.birch_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.jungle_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.dark_oak_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.acacia_fence, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.oak_stairs, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.birch_stairs, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.spruce_stairs, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.jungle_stairs, 5, 20);
        LFBlocks.lffire.setFireInfo(Blocks.log, 5, 5);
        LFBlocks.lffire.setFireInfo(Blocks.log2, 5, 5);
        LFBlocks.lffire.setFireInfo(Blocks.leaves, 30, 60);
        LFBlocks.lffire.setFireInfo(Blocks.leaves2, 30, 60);
        LFBlocks.lffire.setFireInfo(Blocks.bookshelf, 30, 20);
        LFBlocks.lffire.setFireInfo(Blocks.tnt, 15, 100);
        LFBlocks.lffire.setFireInfo(Blocks.tallgrass, 60, 100);
        LFBlocks.lffire.setFireInfo(Blocks.double_plant, 60, 100);
        LFBlocks.lffire.setFireInfo(Blocks.yellow_flower, 60, 100);
        LFBlocks.lffire.setFireInfo(Blocks.red_flower, 60, 100);
        LFBlocks.lffire.setFireInfo(Blocks.deadbush, 60, 100);
        LFBlocks.lffire.setFireInfo(Blocks.wool, 30, 60);
        LFBlocks.lffire.setFireInfo(Blocks.vine, 15, 100);
        LFBlocks.lffire.setFireInfo(Blocks.coal_block, 5, 5);
        LFBlocks.lffire.setFireInfo(Blocks.hay_block, 60, 20);
        LFBlocks.lffire.setFireInfo(Blocks.carpet, 60, 20);
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        {
            if (LFBlocks.lffire.canCatchFire(worldIn, pos.west(), EnumFacing.EAST))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (LFBlocks.lffire.canCatchFire(worldIn, pos.east(), EnumFacing.WEST))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (LFBlocks.lffire.canCatchFire(worldIn, pos.north(), EnumFacing.SOUTH))
            {
                for (i = 0; i < 2; ++i)
                {
            ...
            if (LFBlocks.lffire.canCatchFire(worldIn, pos.south(), EnumFacing.NORTH))
            {
                for (i = 0; i < 2; ++i)
                {
                    d0 = (double)pos.getX() + rand.nextDouble();
            ...
            if (LFBlocks.lffire.canCatchFire(worldIn, pos.up(), EnumFacing.DOWN))
            {
                for (i = 0; i < 2; ++i)
                {
                    d0 = (double)pos.getX() + rand.nextDouble();
